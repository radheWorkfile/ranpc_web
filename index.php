				  ...
				  <div class="card-img-overlay">
					  <div class="row text-center">
						  <div class="col-1"></div>
							  ...
							  <h1 class="card-title caption-line text-anim">Best College For <br>Nursing & Paramedical</h1>
...
<!--//slider-->
	...
	<div class="container mt-lg-5 mt-3">
		<div class="row">
			<div class="col-md-8">
				<h3 class="text-danger mb-2 text-anim">Welcome to <span class="special-font">Raj Aryan Nursing &amp; Paramedical College</span></h3>
