...
<?php include('include/default.php');?>
		...
		<div class="col-sm-12 pt-2 px-3 lead">
			<ul class="small text-white list-unstyled mb-2 mt-1">
				<li><i class="fas fa-phone fa-rotate-90 px-2 "></i><span>
					<a href="tel:<?php echo $mobile_1;?>" class="text-white">+91 <?php echo $mobile_1; ?></a> <span class="text-warning">/</span> <a href="tel:<?php echo $mobile_2;?>" class="text-white">+91 <?php echo $mobile_2; ?></a></span></li>
	...
	<nav class="navbar navbar-expand-lg navbar-light  sticky-top">
		<a class="navbar-brand" href="index.php"><img src="images/logo.png" class="img-fluid w-25 logo-img" alt="logo">&nbsp;</a>
