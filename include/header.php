			...
			<div class="col-sm-12 pt-2 px-3 lead">
				<ul class="small text-white list-unstyled mb-2 mt-1">
					<li><i class="fas fa-phone fa-rotate-90 px-2 "></i><span>
							<a href="tel:+91 9905417686" class="text-white">+91 9905417686</a> <span
								class="text-warning">/</span> <a href="tel:+91 9308819517" class="text-white">+91
								9308819517</a></span></li>
			...
			<div class="collapse navbar-collapse" id="navbarNavDropdown">
				<ul class="navbar-nav ml-auto">
					<li class="nav-item active">
						<a class="nav-link" href="index.php"><i class="fa fa-home" aria-hidden="true"
								style="font-size:1rem;"></i> Home <span class="sr-only"></span></a>
					</li>
					<li class="nav-item">
					...
					<li class="nav-item dropdown">
						...
						<div class="dropdown-content">
							...
							<a href="bsc-nursing.php">PB. B. Sc. Nursing</a>
				...
				<div class="dropdown-content" style="width:300px;">
				  ...
				  <a href="hospital_management.php">Bachelor In Hospital Management</a>
					...
					<!-- <li class="nav-item">
			  <a class="nav-link" href="contact-us.php">Academic</a>
			</li> -->
					<li class="nav-item">
