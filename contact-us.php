...
<head>
	...
	<style>
		.cus-card{border:1px dashed black;border-radius:22px 1px 22px 1px;}
		.cus-card:hover{background: linear-gradient(to right, #c6edb0, #cdefe5);border:none;border-radius:1px 22px 1px 22px;}
		.a-man{color:#5e2236;}
	...
	<div class="container mt-lg-5 mt-3">
		<div class="row text-center">
			...
			<div class="py-4 cus-card">
				...
				<p class="text-red">E-Mail : <a href="mailto:<?php echo $email;?>"class="a-man"><?php echo $email;?></a></p>
				
				<p class="text-red" ><i class="fas fa-phone fa-rotate-90 px-2 "></i>+91 <?php echo $mobile_1.' '.$mobile_2;?></p>
			...
			<div class="py-4 cus-card">
				...
				<p class="text-red py-3">
					...
					<a target="_blank" href="#" class="a-man"><i class="fab fa-youtube mx-2 rounded"></i></a>
				</p>
			</div>
			</div>
		</div>
