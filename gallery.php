        ...
        <div class="container">
            ...
            <div class="row my-5">
                <div class="col-md-8 offset-md-2">
                    ...
                    <p class="text-center mt-1 text-dark">Explore our vibrant gallery showcasing moments of creativity, inspiration, and community—capturing the essence of our journey through stunning visuals.</p>
                </div>
            </div>
