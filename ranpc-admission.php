...
<head>
	<title>Admission | Raj Aryan Nursing & Paramedical College</title>
	<!-- Meta tag Keywords -->
		...
		<section>
			<div class="container-fluid p-0 ">
				<div class="container mt-lg-5 mt-3">
					<div class="row">
						<div class="col-md-8">
							<h3 class="text-red mb-4 special-font wow animate__ animate__zoomIn  animated"
								data-wow-delay="0.5s" data-wow-duration="1.5s">Eligibility & Selection Criteria</h3>
