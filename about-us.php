       ...
       <div class="container mt-lg-5 mt-3">
           <div class="row">
               <div class="col-md-8 px-4">
				...
				<p class="text-justify text-dark"><b><?php echo $company;?> </b>is a forward-looking initiative launched by the Aryaman Educational Trust, dedicated to advancing health education. Its core mission is to nurture compassionate, highly skilled nurses and midwives capable of delivering outstanding maternity care and contributing meaningfully to society.</p>
				<p class="text-justify text-dark">The college prides itself on a well-regarded teaching faculty that firmly believes a strong education forms the foundation of a successful professional journey. To ensure consistent academic growth, students undergo regular assessments that help them track progress and stay motivated to excel.</p></div>
               <div class="col-md-4">
