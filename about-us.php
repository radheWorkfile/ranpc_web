...
<section>
   ...
   <section class="my-5">
       <div class="container mt-lg-5 mt-3">
           <div class="row">
               <div class="col-md-8">
				<h3 class="text-danger mb-2"><span class="special-font">About Us</span></h3>
				<p class="text-justify text-dark">Raj Aryan Nursing & Paramedical College is a recent endeavor launched by Aryaman Educational Trust in the sphere of health education. It is committed to equipping humanity with nurses and midwives who are not only professionally skilled but also humanitarian in nature, offering superior maternity services.</p>
				<p class="text-justify text-dark">The college is supported by a widely respected teaching team that strongly believes quality education is essential to building a strong career. Regular exams are held to give students performance feedback, motivating them to improve. Our teaching approach encourages multidisciplinary questioning and hands-on problem-solving. We use interactive methods to promote dynamic exchanges between students and educators in the classroom.</p></div>
               <div class="col-md-4">
